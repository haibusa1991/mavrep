...
public class AddUserTest {
    ...
    @SneakyThrows
    @Test
    public void returns201WhenOwnerAddsExistingUser() {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                        .post(String.format(this.URI_TEMPLATE, this.EXISTING_VAULT_1))
    ...
    @SneakyThrows
    @Test
    public void returns200WhenOwnerAddsExistingUserWhichAlreadyIsAuthorized() {
        Vault vault1 = this.vaultRepository.findAll().get(0);
        vault1.addUser(this.EXISTING_USER_2);
        this.vaultRepository.save(vault1);
    ...
    @SneakyThrows
    @Test
    public void returns403WhenNonOwnerAddsExistingUser() {
    ...
    @Test
    @SneakyThrows
    public void returns404WhenOwnerAddsNonExistingUser() {
        String uri = String.format(this.URI_TEMPLATE, this.EXISTING_VAULT_1);
    ...
    @Test
    @SneakyThrows
    public void returns404WhenOwnerAddsExistingUserToNonExistingVault() {
